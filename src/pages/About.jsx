const About = () => {
	return (
		<div className="text-[#ffffffad] px-4 md:px-0">
			<div className="grid md:grid-cols-2 gap-x-10 min-h-min">
				<div className="">
					<p className="uppercase text-3xl pb-4 text-white">who is udoka?</p>
			...
			<div className="py-4"></div>
			<div  className="text-center text-[#ffffffad]">
				...
				blend creativity with technical prowess and also render these <span className="text-white">SERVICES</span>
			</div>
		</div>
	);
};
